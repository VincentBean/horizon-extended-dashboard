...
class QueueMemoryChart extends Component
{
    public string $queue;
    ...
    {
        return view('horizondashboard::livewire.components.charts.queue-memory-chart', ['model' => $this->getChartModel()]);
    }
    ...
    protected function getChartModel(): LineChartModel
    {
        ...
        QueueStatistic::query()
            ...
            ->each(function(QueueStatistic $statistic) use ($chartModel) {
                ...
                $chartModel->addPoint($statistic->snapshot_at->toDateTimeString(), $statistic->memory_usage);
